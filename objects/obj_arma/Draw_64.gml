...
//draw_text_transformed(20+(gw*qtd),texto_margy*3	,sons					,texto_xesc,texto_yesc,0)
//draw_text_transformed(20+(gw*qtd),texto_margy*4	,som_tiro				,texto_xesc,texto_yesc,0)
//draw_text_transformed(20+(gw*qtd),texto_margy*4	,fogo_ix				,texto_xesc,texto_yesc,0)
